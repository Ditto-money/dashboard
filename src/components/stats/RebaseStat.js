...
export default function () {
  ...
  return (
    <Tooltip title={'Triggers the rebase. Try increasing the gas limit if your transaction fails.'} placement={'top'}>
      <div>
        <Paper variant="outlined" elevation={0}>
          <div></div>
          <div>
            <Button variant="contained" color="secondary" disabled={!cooldownExpired || isRebasing} onClick={connectOrRebase}>
